        ...
        AppleOfMyIframe = $.extend(
            ...
            },
            {
                ...
                prototype: $.extend(
                    ...
                    {
                        init: function(args){
                            var that = this, contents, optionsFound, callback, attr, iframeAndParents;
                            ...
                            function iframeElementMoved(){
                                ...
                                iframeAndParents.unbind('DOMNodeInserted', iframeElementMoved);
                                that.body();
                                iframeAndParents = that.parents().andSelf();
                                iframeAndParents.bind('DOMNodeInserted', iframeElementMoved);
                            }
                            this.ready(function(){
                                iframeAndParents = this.parents().andSelf();                            
                                iframeAndParents.bind('DOMNodeInserted', iframeElementMoved);
                            });
